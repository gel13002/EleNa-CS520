...
static PyObject *const_str_digest_1c937d6afcbf48e35c869ac89e59ab5d;
...
{
    const_tuple_c7857aa12bb2e86b5fb641a93cd629e0_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 53065 ], 26885 );
    const_str_digest_0f315324483a843be058846d7c63975f = UNSTREAM_STRING( &constant_bin[ 79950 ], 26, 0 );
    const_str_digest_10a0f1ada1e698398f1a37a36b457666 = UNSTREAM_STRING( &constant_bin[ 79958 ], 17, 0 );
    const_str_digest_1c937d6afcbf48e35c869ac89e59ab5d = UNSTREAM_STRING( &constant_bin[ 79976 ], 98, 0 );
...
static PyCodeObject *codeobj_6139072beb73da99d64976e39e9699d5;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_1c937d6afcbf48e35c869ac89e59ab5d;
    codeobj_6139072beb73da99d64976e39e9699d5 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_0f315324483a843be058846d7c63975f, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_6139072beb73da99d64976e39e9699d5;
    ...
    tmp_assign_source_2 = const_str_digest_1c937d6afcbf48e35c869ac89e59ab5d;
    ...
    // Frame without reuse.
    frame_6139072beb73da99d64976e39e9699d5 = MAKE_MODULE_FRAME( codeobj_6139072beb73da99d64976e39e9699d5, module_chardet$euctwfreq );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_6139072beb73da99d64976e39e9699d5 );
    assert( Py_REFCNT( frame_6139072beb73da99d64976e39e9699d5 ) == 2 );

    // Framed code:
    frame_6139072beb73da99d64976e39e9699d5->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_6139072beb73da99d64976e39e9699d5 );
#endif
    popFrameStack();

    assertFrameObject( frame_6139072beb73da99d64976e39e9699d5 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_6139072beb73da99d64976e39e9699d5, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_6139072beb73da99d64976e39e9699d5->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_6139072beb73da99d64976e39e9699d5, exception_lineno );
    }
