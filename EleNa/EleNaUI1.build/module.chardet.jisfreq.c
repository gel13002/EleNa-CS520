...
static PyObject *const_str_digest_9012361315cc3907183118611d7beb02;
...
{
    const_tuple_435ed3830ae955262dd096d82966c5a6_tuple = PyMarshal_ReadObjectFromString( (char *)&constant_bin[ 100314 ], 21845 );
    const_float_3_0 = UNSTREAM_FLOAT( &constant_bin[ 122159 ] );
    const_str_digest_9012361315cc3907183118611d7beb02 = UNSTREAM_STRING( &constant_bin[ 122167 ], 96, 0 );
    const_int_pos_4368 = PyLong_FromUnsignedLong( 4368ul );
    const_str_digest_a17e0e40accb64aefe6a116495d7affd = UNSTREAM_STRING( &constant_bin[ 122263 ], 24, 0 );
    const_str_digest_ea9ca92ff482b90cfb7ad9a3c895c6d4 = UNSTREAM_STRING( &constant_bin[ 122271 ], 15, 0 );
...
static PyCodeObject *codeobj_f58d2ce6ac7aa7cd995e6eb5a8f9e383;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_9012361315cc3907183118611d7beb02;
    codeobj_f58d2ce6ac7aa7cd995e6eb5a8f9e383 = MAKE_CODEOBJ( module_filename_obj, const_str_digest_a17e0e40accb64aefe6a116495d7affd, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383;
    ...
    tmp_assign_source_2 = const_str_digest_9012361315cc3907183118611d7beb02;
    ...
    // Frame without reuse.
    frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383 = MAKE_MODULE_FRAME( codeobj_f58d2ce6ac7aa7cd995e6eb5a8f9e383, module_chardet$jisfreq );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383 );
    assert( Py_REFCNT( frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383 ) == 2 );

    // Framed code:
    frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383->m_frame.f_lineno = 1;
    {
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383 );
#endif
    popFrameStack();

    assertFrameObject( frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_f58d2ce6ac7aa7cd995e6eb5a8f9e383, exception_lineno );
    }
