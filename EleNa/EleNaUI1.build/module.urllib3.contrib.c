...
static PyObject *const_str_digest_54751d9d1fe3bd17bc2365c770e762a0;
...
static PyObject *const_list_str_digest_d5cfd9c6093bcb314c973db39ac870f3_list;
static PyObject *const_str_digest_d5cfd9c6093bcb314c973db39ac870f3;
...
{
    const_str_digest_6975fd07d5b5e85a18ab2ed197d08f84 = UNSTREAM_STRING( &constant_bin[ 866963 ], 24, 0 );
    const_str_digest_54751d9d1fe3bd17bc2365c770e762a0 = UNSTREAM_STRING( &constant_bin[ 866987 ], 105, 0 );
    const_list_str_digest_d5cfd9c6093bcb314c973db39ac870f3_list = PyList_New( 1 );
    const_str_digest_d5cfd9c6093bcb314c973db39ac870f3 = UNSTREAM_STRING( &constant_bin[ 866987 ], 93, 0 );
    PyList_SET_ITEM( const_list_str_digest_d5cfd9c6093bcb314c973db39ac870f3_list, 0, const_str_digest_d5cfd9c6093bcb314c973db39ac870f3 ); Py_INCREF( const_str_digest_d5cfd9c6093bcb314c973db39ac870f3 );
...
static PyCodeObject *codeobj_aafa21117f3638b8c9a29e2d494eb59c;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_54751d9d1fe3bd17bc2365c770e762a0;
    codeobj_aafa21117f3638b8c9a29e2d494eb59c = MAKE_CODEOBJ( module_filename_obj, const_str_digest_6975fd07d5b5e85a18ab2ed197d08f84, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_aafa21117f3638b8c9a29e2d494eb59c;
    ...
    tmp_assign_source_2 = const_str_digest_54751d9d1fe3bd17bc2365c770e762a0;
    UPDATE_STRING_DICT0( moduledict_urllib3$contrib, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2 );
    tmp_assign_source_3 = LIST_COPY( const_list_str_digest_d5cfd9c6093bcb314c973db39ac870f3_list );
    ...
    // Frame without reuse.
    frame_aafa21117f3638b8c9a29e2d494eb59c = MAKE_MODULE_FRAME( codeobj_aafa21117f3638b8c9a29e2d494eb59c, module_urllib3$contrib );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_aafa21117f3638b8c9a29e2d494eb59c );
    assert( Py_REFCNT( frame_aafa21117f3638b8c9a29e2d494eb59c ) == 2 );

    // Framed code:
    frame_aafa21117f3638b8c9a29e2d494eb59c->m_frame.f_lineno = 1;
    {
    ...
    tmp_args_element_name_1 = const_str_digest_e03852224018ed217937e454110a99e9;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_aafa21117f3638b8c9a29e2d494eb59c );
#endif
    popFrameStack();

    assertFrameObject( frame_aafa21117f3638b8c9a29e2d494eb59c );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_aafa21117f3638b8c9a29e2d494eb59c, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_aafa21117f3638b8c9a29e2d494eb59c->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_aafa21117f3638b8c9a29e2d494eb59c, exception_lineno );
    }
